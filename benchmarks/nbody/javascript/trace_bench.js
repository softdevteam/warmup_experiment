...
function Body(x,y,z,vx,vy,vz,mass,buffer,bodyIndex) {
   print("function Body(x,y,z,vx,vy,vz,mass,buffer,bodyIndex) {");
...
Body.prototype.offsetMomentum = function(px,py,pz) {
   print("Body.prototype.offsetMomentum = function(px,py,pz) {");
...
function Jupiter(buffer, bodyIndex){
   print("function Jupiter(buffer, bodyIndex){");
   return new Body(
...
function Saturn(buffer, bodyIndex){
   print("function Saturn(buffer, bodyIndex){");
   return new Body(
...
function Uranus(buffer, bodyIndex){
   print("function Uranus(buffer, bodyIndex){");
   return new Body(
...
function Neptune(buffer, bodyIndex){
   print("function Neptune(buffer, bodyIndex){");
   return new Body(
...
function Sun(buffer, bodyIndex){
   print("function Sun(buffer, bodyIndex){");
...
function NBodySystem(bodies){
   print("function NBodySystem(bodies){");
   /**
    * @type {Array.<Body>}
    */
   this.bodies = bodies;
...
NBodySystem.prototype.advance = function(dt){
   print("NBodySystem.prototype.advance = function(dt){");
...
NBodySystem.prototype.energy = function(){
   print("NBodySystem.prototype.energy = function(){");
