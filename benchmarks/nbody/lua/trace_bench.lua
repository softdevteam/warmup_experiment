...
local function advance(bodies, nbody, dt)
  print("local function advance(bodies, nbody, dt)")
  for i=1,nbody do
    print("for i=1,nbody do")
    local bi = bodies[i]
    local bix, biy, biz, bimass = bi.x, bi.y, bi.z, bi.mass
    local bivx, bivy, bivz = bi.vx, bi.vy, bi.vz
    for j=i+1,nbody do
      print("for j=i+1,nbody do")
      local bj = bodies[j]
...
local function energy(bodies, nbody)
  print("local function energy(bodies, nbody)")
  local e = 0
  for i=1,nbody do
    print("for i=1,nbody do")
    local bi = bodies[i]
...
local function offsetMomentum(b, nbody)
  print("local function offsetMomentum(b, nbody)")
