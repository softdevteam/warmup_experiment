...
function energy(&$b) {
   echo 'function energy(&$b) {', "\n";
   $e = 0.0;
   for ($i=0,$m=sizeof($b);$i<$m;$i++) {
       echo 'for ($i=0,$m=sizeof($b);$i<$m;$i++) {', "\n";
       $b1=$b[$i]; 
       $e += 0.5*$b1[6]*($b1[3]*$b1[3]+$b1[4]*$b1[4]+$b1[5]*$b1[5]);
       for ($j=$i+1; $j<$m; $j++) {
          echo 'for ($j=$i+1; $j<$m; $j++) {', "\n";
	  $b2=$b[$j];
...
for ($i=0,$m=count($bodies); $i<$m; $i++) {
   echo 'for ($i=0,$m=count($bodies); $i<$m; $i++) {', "\n";
   for ($j=$i+1; $j<$m; $j++) {
      echo 'for ($j=$i+1; $j<$m; $j++) {', "\n";
